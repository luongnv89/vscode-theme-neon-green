...
AURA = {
    ...
    "palette": {
        ...
        "mid": "#9a97a8", "muted": "#6d6d6d", "subtle": "#4a4a4a",
        ...
        "comment": "#4a4a4a", "docComment": "#6d6d6d", "jsdoc": "#8a8a96",
        "escape": "#ff6767",
...
ZED_DARK = {
    ...
    "palette": {
        ...
        "comment": "#5d636f", "docComment": "#878a98", "jsdoc": "#8a9098",
        "escape": "#6eb4bf",
...
ZED_LIGHT = {
    ...
    "palette": {
        ...
        "comment": "#a2a3a7", "docComment": "#7e8086", "jsdoc": "#58585a",
